...
const Login = () => {
    ...
    const performLogin = async (credentials) => {
        try {
            const response = await axios.post('https://recollect.lokeshdev.co:3000/api/auth/login', credentials);
    ...
    const handleOTPSubmit = async (e) => {
        ...
        try {
            await axios.post('https://recollect.lokeshdev.co:3000/api/auth/verify-otp', { 
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!isLoginVisible) {
                ...
                await axios.post('https://recollect.lokeshdev.co:3000/api/auth/send-otp', { email, password });
