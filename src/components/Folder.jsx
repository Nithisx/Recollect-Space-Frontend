...
import FaceFinder from "./Face"
import { PlusCircleIcon, ArrowUpTrayIcon, Squares2X2Icon, ListBulletIcon, XMarkIcon } from "@heroicons/react/24/solid"
...
const FolderPage = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const encryptedFiles = await Promise.all(files.map((file) => clientEncrypt(file)))
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
              ...
              {selectedPhotoIndex === null ? (
                ...
                <div className="flex flex-col items-center">
                  <img
                    ...
                    src={
                      decryptedPhotos[photos[selectedPhotoIndex]._id] || `/placeholder-image.jpg` || "/placeholder.svg"
                    }
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-40 transition-opacity duration-300 opacity-100">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg p-8 transform transition-all duration-300 scale-100 hover:scale-105">
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={closeUploadModal} className="text-gray-500 hover:text-gray-700 transition-colors">
              ...
              {/* File Input */}
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-600 mb-2">Selected files: {files.length}</label>
                <input
                  type="file"
        ...
        {/* Use the enhanced FaceFinder component */}
        <FaceFinder folderId={folderId} />
      </div>
    </>
  )
}
