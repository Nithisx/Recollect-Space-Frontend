...
export const Myfiles = () => {
  ...
  const fetchFolders = async (userId) => {
    try {
      ...
      const ownedRes = await axios.get(
        `https://recollect.lokeshdev.co/api/folders/user/${userId}`,
        {
      ...
      const sharedRes = await axios.get(
        `https://recollect.lokeshdev.co/api/folders/shared`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const addFolder = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://recollect.lokeshdev.co/api/folders/create-folder',
        {
  ...
  const deleteFolder = async (folderId) => {
    try {
      ...
      await axios.delete(`https://recollect.lokeshdev.co/api/folders/${folderId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const ShareFolderModal = ({ isOpen, onClose, folderId, onShare }) => {
    ...
    const handleShare = async () => {
      try {
        ...
        const response = await axios.post(
          `https://recollect.lokeshdev.co/api/folders/${folderId}/share`,
          { email, permission },
          { headers: { Authorization: `Bearer ${token}` } }
        );
